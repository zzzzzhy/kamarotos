...
del_list uhttpd.main.listen_http="${router_ip}:80"
del_list uhttpd.main.listen_https="${router_ip}:443"
...
set dhcp.efi64_boot_3=match
set dhcp.efi64_boot_3.networkid='set:bios'
set dhcp.efi64_boot_3.match='60,PXEClient:Arch:X86PC'
...
set dhcp.bios=boot
set dhcp.bios.filename='tag:bios,undionly.kpxe'
set dhcp.bios.serveraddress="${router_ip}"
set dhcp.bios.servername='pxe'
set dhcp.bios.force='1'
set dhcp.ipxe=boot
